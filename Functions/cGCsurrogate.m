%% NULL DISTRIBUTION EVALUATION FOR CONDITIONAL GRANGER CAUSALITY
...
% p, model order
%%% output,
% Fi_jsSurr, M*M*iter matrix of surrogate values for conditional GC
%
function [Fi_jsSurr]=cGCsurrogate(Y,iter,p)
